...
def forecast_future( question="Will I win the lottery?", responses)
	random_key = responses.keys[rand(responses.size)]
	puts "#{responses[random_key].sample}"
end

3.times do
	print "Ask the fortune 8 ball a question (or hit enter for a default question to be asked: Will I win the lottery?): "
	question = gets.chomp
