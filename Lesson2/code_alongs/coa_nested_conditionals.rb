...
if guess.downcase == programs_day_of_week.downcase
	puts "Correct!"
else
	puts "Wrong!"
end
...
if day_guess.downcase == day_of_week && number == number_guess
	puts "Correct!"
elsif day_guess.downcase == day_of_week
	puts "Day correct!"
...
case 
	when day_guess.downcase == day_of_week && number == number_guess
		puts "Correct!"
	when  day_guess.downcase == day_of_week 
		puts "Day correct"
	when number == number_guess
		puts "Number correct"
	else
		puts "Wrong!"
	end
...
if day_guess.downcase == day_of_week ||  number_guess == number
	puts "Win!"
else
	puts "Loose!"
end
