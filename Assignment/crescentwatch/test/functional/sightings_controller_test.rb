...
class SightingsControllerTest < ActionController::TestCase
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post :create, sighting: { comments: @sighting.comments, photo: @sighting.photo, sighted: @sighting.sighted, visibility: @sighting.visibility }
    end
  ...
  test "should update sighting" do
    put :update, id: @sighting, sighting: { comments: @sighting.comments, photo: @sighting.photo, sighted: @sighting.sighted, visibility: @sighting.visibility }
    assert_redirected_to sighting_path(assigns(:sighting))
  end
